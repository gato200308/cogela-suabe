...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $edad = trim($_POST['edad']); // Añadir el rol
    ...
    if ($checkUserStmt->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO usuario (identificacion, nombres, apellidos, fecha_nacimiento, telefono, genero, Edad, correo, contrasena) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssiss", $identificacion, $nombre, $apellido, $fechaNacimiento, $telefono, $genero, $edad, $correo, $hashedContrasena);
